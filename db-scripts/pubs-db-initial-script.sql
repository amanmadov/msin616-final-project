...
if db_name() <> 'pubs' raiserror('Error in InstPubs.SQL, ''USE pubs'' failed!  Killing the SPID now.', 22, 127) with log
...
(
   au_id id    CHECK (au_id like '[0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]') CONSTRAINT UPKCL_auidind PRIMARY KEY CLUSTERED,
...
insert pub_info values('0736', NULL, 'This is sample text data for New Moon Books, publisher 0736 in the pubs database. New Moon Books is located in Boston, Massachusetts.')
insert pub_info values('0877', NULL, 'This is sample text data for Binnet & Hardley, publisher 0877 in the pubs database. Binnet & Hardley is located in Washington, D.C.')
insert pub_info values('1389', NULL, 'This is sample text data for AlGOdata Infosystems, publisher 1389 in the pubs database. AlGOdata Infosystems is located in Berkeley, California.')
insert pub_info values('1622', NULL, 'This is sample text data for Five Lakes Publishing, publisher 1622 in the pubs database. Five Lakes Publishing is located in ChicaGO, Illinois.')
insert pub_info values('1756', NULL, 'This is sample text data for Ramona Publishers, publisher 1756 in the pubs database. Ramona Publishers is located in Dallas, Texas.')
insert pub_info values('9901', NULL, 'This is sample text data for GGG&G, publisher 9901 in the pubs database. GGG&G is located in M�nchen, Germany.')
insert pub_info values('9952', NULL, 'This is sample text data for Scootney Books, publisher 9952 in the pubs database. Scootney Books is located in New York City, New York.')
insert pub_info values('9999', NULL, 'This is sample text data for Lucerne Publishing, publisher 9999 in the pubs database. Lucerne publishing is located in Paris, France.')
